        ...
        <div className="py-24 sm:py-32 bg-[#0C0F1D]">
            <div className="container max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="relative max-w-5xl mx-auto">
                    <div className="absolute left-4 top-2 h-full w-0.5 bg-[#C5A059]/20 lg:left-1/2 lg:-translate-x-1/2" aria-hidden="true" />

                    <div className="space-y-16">
                        {timelineData.map((item, index) => (
                            <div key={index} className="relative">
                                <motion.div 
                                    className="absolute left-4 top-2 h-5 w-5 -translate-x-1/2 rounded-full bg-[#111623] border-2 border-[#C5A059] lg:left-1/2"
                                ...
                                >
                                    <div className="p-6 bg-[#111623] rounded-xl border border-[#C5A059]/[0.16] shadow-2xl shadow-black/20 hover:border-[#C5A059]/40 hover:-translate-y-1.5 transition-all duration-300 group">
                                        <div className="flex justify-between items-start mb-2 flex-col sm:flex-row">
                                            ...
                                            <p className="text-sm text-[#A8B0C2] font-semibold whitespace-nowrap mt-1 sm:mt-0">{item.duration}</p>
                                        </div>
                                        <p className="text-md text-[#C5A059] font-medium mb-4">{item.org}</p>
                                        <ul className="list-disc list-inside text-[#A8B0C2] space-y-2 text-sm marker:text-[#C5A059]">
                                            {item.responsibilities.map((resp, i) => <li key={i}>{resp}</li>)}
                                        </ul>
                                        <div className="mt-4 flex flex-wrap gap-2">
                                            {item.skills.map(skill => <span key={skill} className="px-3 py-1 text-xs border border-[#C5A059]/20 bg-gray-700/30 text-gray-300 rounded-full">{skill}</span>)}
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div key={ach.title} variants={itemVariants} className="p-6 bg-[#111623] rounded-xl border border-[#C5A059]/[0.16] transition-all duration-300 hover:border-[#C5A059]/40 hover:-translate-y-1.5 shadow-lg shadow-black/20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {focusData.map((focus) => (
                            <motion.div
                                ...
                                tabIndex={0}
                                className="group cursor-pointer grid grid-cols-[min-content_1fr] gap-x-[14px] gap-y-2 px-7 pt-7 pb-6 rounded-[14px] bg-[#111623] border border-[rgba(197,160,89,0.12)] shadow-[0_10px_30px_rgba(0,0,0,0.35)] transition-all duration-[220ms] ease-out motion-safe:hover:-translate-y-0.5 motion-safe:focus-visible:-translate-y-0.5 hover:border-[rgba(197,160,89,0.45)] focus-visible:border-[rgba(197,160,89,0.45)] focus-visible:outline-none hover:shadow-[0_14px_40px_rgba(197,160,89,0.18),_0_10px_30px_rgba(0,0,0,0.35)] focus-visible:shadow-[0_14px_40px_rgba(197,160,89,0.18),_0_10px_30px_rgba(0,0,0,0.35)]"
                            >
                                ...
                                <ul className="list-disc list-inside text-sm text-[#A8B0C2] col-start-2 space-y-2 marker:text-[#C5A059]">
